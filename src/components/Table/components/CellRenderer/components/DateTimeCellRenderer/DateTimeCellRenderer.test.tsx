...
type Props = React.ComponentProps<typeof DateTimeCellRenderer>;

describe('DateTimeCellRenderer', () => {
  /**
   * Selectors
   */
  const getSelectors = getJestSelectors(TEST_IDS.dateTimeCellRenderer);
  ...
  const getComponent = (props: Partial<Props>) => {
    return <DateTimeCellRenderer renderValue={jest.fn()} {...(props as any)} />;
  };
